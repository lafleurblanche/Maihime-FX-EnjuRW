...
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn08
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn09
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn10
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn11
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn12
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn13
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn14
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn15
...
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn37
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn38
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn39
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn40
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn41
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn42
import net.konohana.sakuya.maihime.enjurw.utils.code.getToStaCodeOp2Btn43
...
class Ticket01Controller : Initializable {
    ...
    /** 苆谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn08Click() {
        val toStaCodeText = getToStaCodeOp2Btn08()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 拯川(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn09Click() {
        val toStaCodeText = getToStaCodeOp2Btn09()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 上拯川(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn10Click() {
        val toStaCodeText = getToStaCodeOp2Btn10()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 茄谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn11Click() {
        val toStaCodeText = getToStaCodeOp2Btn11()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 笥谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn12Click() {
        val toStaCodeText = getToStaCodeOp2Btn12()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 岩組(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn13Click() {
        val toStaCodeText = getToStaCodeOp2Btn13()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 筏谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn14Click() {
        val toStaCodeText = getToStaCodeOp2Btn14()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 宿田(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn15Click() {
        val toStaCodeText = getToStaCodeOp2Btn15()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 瑞堂(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn16Click() {
        val toStaCodeText = getToStaCodeOp2Btn16()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 筮谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn17Click() {
        val toStaCodeText = getToStaCodeOp2Btn17()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 東瑞堂(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn37Click() {
        val toStaCodeText = getToStaCodeOp2Btn37()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 苕谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn38Click() {
        val toStaCodeText = getToStaCodeOp2Btn38()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 扆谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn39Click() {
        val toStaCodeText = getToStaCodeOp2Btn39()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 珩谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn40Click() {
        val toStaCodeText = getToStaCodeOp2Btn40()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 玿谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn41Click() {
        val toStaCodeText = getToStaCodeOp2Btn41()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 珮谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn42Click() {
        val toStaCodeText = getToStaCodeOp2Btn42()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
    ...
    /** 荍谷(降車駅)ボタン押下時処理 */
    @FXML
    private fun onToStaOp2Btn43Click() {
        val toStaCodeText = getToStaCodeOp2Btn43()
        toStaTextField.text = toStaCodeText.first
        toStaCodeTextField.text = toStaCodeText.second
        toStaCode = toStaCodeText.second
    }
